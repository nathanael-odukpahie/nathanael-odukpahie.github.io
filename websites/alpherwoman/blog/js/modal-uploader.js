    ...
    $("body").delegate("#d-sub", "click", function(e){
        ...
        if (modalUploader.files != "") {
                        ...
                        <div class="col-md-12 my-2 pt-2">
                            <div class="px-4 row">
                                <div class="col-9 d-flex">
                                    <div class="mr-2">
                                        <img src="blog/images/course_img.png" class="mt-1" />
                                    </div>
                            ...
                            <div class="px-4">
                                <p class="font-14 font-weight-light">`+$('#media-texts').val()+`</p>
                            </div>
                            <div class="row">
                            ...
                            <div class="px-4 row mt-3">
                                <div class="col-lg-12 col-12 d-flex">
                                    <img src="blog/images/course_img.png" class="mt-1 mr-2" />
                                    ...
                                    <button class="btn btn-sm btn-alpher mt-2 comment-send" data-id="comment-`+time+`" data-load="p`+time+`">Send</button>
                                </div>
                            ...
                            <div class="text-center my-2">
                                <button class="btn btn-sm btn-alpher show-drop" id="comment-`+time+`">Show Comment</button>
                            </div>
            ...
            $.ajax({
                ...
                data: JSON.stringify({"files":up_file,"media-texts":$('#media-texts').val()}),
                processData: false,
            ...
            $.ajax({
                ...
                type: 'post',
                contentType: 'application/json',
                data: JSON.stringify({"media-texts":$('#media-texts').val()}),
                processData: false,
                success: function( data, textStatus, jQxhr ){
                    $('#response pre').html( JSON.stringify( data ) );
                },
